...
/* package hacker-rank-0.1.0.0 */
#define VERSION_hacker_rank "0.1.0.0"
#define MIN_VERSION_hacker_rank(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "hacker-rank-0.1.0.0-GjpRxb8iNAQ3hTKyQdsJV0"

#define CURRENT_PACKAGE_KEY "hacker-rank-0.1.0.0-GjpRxb8iNAQ3hTKyQdsJV0"
